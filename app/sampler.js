...
export default function sampler() {
  ...
  function playSample(instrument, note, destination, delaySeconds = 0, pitchShift = 1) {
  ...
  function startLoop(instrument, note, destination, loopLengthSeconds, delaySeconds, pitchShift) {
    playSample(instrument, note, destination, delaySeconds, pitchShift);
    setInterval(
      () => playSample(instrument, note, destination, delaySeconds, pitchShift),
